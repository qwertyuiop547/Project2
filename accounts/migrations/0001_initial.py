# Generated by Django 4.2.25 on 2025-11-02 15:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('resident', 'Resident'), ('secretary', 'Secretary'), ('chairman', 'Chairman')], default='resident', max_length=20)),
                ...
                ('residency_validation_score', models.IntegerField(blank=True, null=True)),
                ('residency_validation_status', models.CharField(blank=True, max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='validation', to=settings.AUTH_USER_MODEL)),
            ...
            options={
                'verbose_name': 'Residency Validation',
                'verbose_name_plural': 'Residency Validations',
            },
        ),
        migrations.CreateModel(
            name='LoginHistory',
